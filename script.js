        ...
        card.innerHTML = `
            ...
            <div class="note-body">
                ...
                <div class="note-financials">
                    ...
                    <span class="note-valor-total">Total: R$ ${n.total.toLocaleString('pt-BR')}</span>
                    <span class="note-valor-parcela">${n.parcelas}x R$ ${valorParcela.toFixed(2)}</span>
                </div>
            </div>
            <div class="note-actions">
                <button onclick="openEditModal(${n.id})" class="btn-delete" style="color:var(--accent); border-color:var(--accent);">✎</button>
